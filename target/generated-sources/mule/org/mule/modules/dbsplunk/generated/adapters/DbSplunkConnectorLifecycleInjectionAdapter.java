...
/**
 * A <code>DbSplunkConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link DbSplunkConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-05-04T04:59:08+01:00", comments = "Build UNNAMED.2793.f49b6c7")
public class DbSplunkConnectorLifecycleInjectionAdapter
    extends DbSplunkConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(DbSplunkConnectorLifecycleInjectionAdapter.class);
